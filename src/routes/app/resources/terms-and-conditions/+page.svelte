...
<Header
	breadcrumbItems={[
		{ icon: 'ph-bold ph-folders', label: 'Resources', href: '' },
		{ label: 'Terms and Conditions', href: '/app/resources/terms-and-conditions' },
	]}
/>
...
<div class="p-4 pt-0">
	<div class="bg-white rounded-md shadow-md p-4">
		...
		<p>Last updated: 2023-08-14</p>
		<p>1. <b>Introduction</b></p>
		<p>
			Welcome to <b>Graystone Institute of the Philippines</b> (“Company”, “we”, “our”, “us”)!
		</p>
		<p>
			These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website
			located at <b>https://graystone-ip-grading-system.onrender.com/</b> (together or
			individually “Service”) operated by <b>Graystone Institute of the Philippines</b>.
		</p>
		<p>
		...
		<p>
			...
			Service, but please let us know by emailing at <b>graystoneip.gradingsystem@gmail.com</b
		...
		<p>
			...
			at graystoneip.gradingsystem@gmail.com.
		</p>
		...
		<p>
			...
			Service. If you participate in any Promotions, please review the applicable rules as
		...
		<p>
			Graystone Institute of the Philippines has the right but not the obligation to monitor
			and edit all Content provided by users.
		</p>
		<p>
			In addition, Content found on or through this Service are the property of Graystone
			Institute of the Philippines or used with permission. You may not distribute, modify,
		...
		<p>
			...
			functionality are and will remain the exclusive property of Graystone Institute of the
			Philippines and its licensors. Service is protected by copyright, trademark, and other
			laws of and foreign countries. Our trademarks may not be used in connection with any
			product or service without the prior written consent of Graystone Institute of the
			Philippines.
		</p>
		...
		<p>
			...
			please submit your claim via email to graystoneip.gradingsystem@gmail.com, with the
			subject line: “Copyright Infringement” and include in your claim a detailed description
			of the alleged Infringement as detailed below, under “DMCA Notice and Procedure for
		...
		<p>You can contact our Copyright Agent via email at graystoneip.gradingsystem@gmail.com.</p>
		<p>12. <b>Error Reporting and Feedback</b></p>
		<p>
			You may provide us either directly at graystoneip.gradingsystem@gmail.com or via third
			party sites and tools with information and feedback concerning errors, suggestions for
		...
		<p>
			...
			controlled by Graystone Institute of the Philippines.
		</p>
		<p>
			Graystone Institute of the Philippines has no control over, and assumes no
		...
		<p>
			Please send your feedback, comments, requests for technical support by email: <b
				>graystoneip.gradingsystem@gmail.com</b
			>.
		</p>
		<p style="margin-top: 5em; font-size: 0.7em;">
			These <a href="https://policymaker.io/terms-and-conditions/">Terms of Service</a> were
			created for <b>https://graystone-ip-grading-system.onrender.com/</b> by
			<a href="https://policymaker.io">PolicyMaker.io</a> on 2023-08-14.
		</p>
	</div>
</div>
