...
{#if modals.adder}
	<ProfessorAdderModal handleClose={closeAdderModal} />
{/if}
{#if target}
	{#if modals.editor}
		<ProfessorEditorModal account={target} handleClose={closeEditorModal} />
	{/if}
{/if}
...
<div class="p-4 pt-0 flex flex-col gap-4">
	...
	<ProfessorTable {...{ professors, openEditorModal }} />
</div>
